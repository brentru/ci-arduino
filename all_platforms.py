...
ALL_PLATFORMS={
    ...
    "wippersnapper_feather_esp32c6_debug" : ["espressif:esp32:adafruit_feather_esp32c6:DebugLevel=verbose,PartitionScheme=no_ota", None, "adafruit/wipper-bsp-3.0.6-idf-5-1-4"],
