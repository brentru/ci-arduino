...
ALL_PLATFORMS={
    ...
    "feather_esp32" : ["esp32:esp32:featheresp32:FlashFreq=80", None, "brentru/master"],
    "feather_esp32_v2" : ["esp32:esp32:adafruit_feather_esp32_v2:PartitionScheme=default,PSRAM=enabled,DebugLevel=verbose", None, "brentru/master"],
    ...
    "qtpy_esp32" : ["esp32:esp32:adafruit_qtpy_esp32_pico", None, "brentru/master"],
    ...
    "picow_rp2040_tinyusb_wippersnapper" : ["rp2040:rp2040:rpipicow:flash=2097152_131072,freq=133,dbgport=Disabled,dbglvl=None,usbstack=tinyusb", "0xe48bff56", None],
